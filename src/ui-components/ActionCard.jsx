...
export default function ActionCard(props) {
  const { ACTIONCARD, overrides, ...rest } = props;
  return (
    <Flex
      gap="0"
      direction="column"
      ...
      >
        ...
        >
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={ACTIONCARD?.post_title}
          ...
          <Text
            ...
            padding="0px 0px 0px 0px"
            whiteSpace="pre-wrap"
            children={ACTIONCARD?.post_description}
        ...
        <Text
          ...
          padding="0px 0px 0px 0px"
          whiteSpace="pre-wrap"
          children={ACTIONCARD?.post_price}
