...
export default function POSTCreateForm(props) {
  ...
  const resetStateValues = () => {
    setPost_image(initialValues.post_image);
    setPost_title(initialValues.post_title);
    setPost_description(initialValues.post_description);
    setPost_category(initialValues.post_category);
    setPost_price(initialValues.post_price);
    setPost_likes(initialValues.post_likes);
    setPost_reviews(initialValues.post_reviews);
    setErrors({});
  };
  const validations = {
    post_image: [{ type: "URL" }],
