...
export default function USERUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = uSERRecord
      ...
      : initialValues;
    setUser_image(cleanValues.user_image);
    setUser_name(cleanValues.user_name);
    setUser_description(cleanValues.user_description);
    setUser_email(cleanValues.user_email);
    setUser_password(cleanValues.user_password);
    setUser_location(cleanValues.user_location);
    setErrors({});
  };
